...
public class Assignment1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Display your name and Student No. here: Linh Dao - 200385751 ");
        ...
        System.out.println("Expected result: FirstName:Jane LastName:Green Balance: 50");
        Account acc1 = new Account("Jane", "Green", 50);
